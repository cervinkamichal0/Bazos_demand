...
public class Scraper {
    public static List<Inzerat> scrapeBazos(String searchTerm) {
        String scrapeUrl = "https://www.bazos.cz/search.php?hledat=" + searchTerm + "&rubriky=www&hlokalita=&humkreis=25&cenaod=&cenado=&Submit=Hledat&order=&kitx=ano";
        ...
        try{
            ...
            for (int i = 1; i<= pocetStranek; i++){
                scrapeUrl = "https://www.bazos.cz/search.php?hledat=" + searchTerm + "&hlokalita=&humkreis=25&cenaod=&cenado=&order=&crz=" + i*20;
